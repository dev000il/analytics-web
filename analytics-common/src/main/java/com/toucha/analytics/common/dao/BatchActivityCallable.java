...
public class BatchActivityCallable /*implements Callable<List<String[]>>*/ {
   ...
   /* String tablename;
    ...
    public BatchActivityCallable(String tablename, List<Get> rks, List<String> selectFields, HConnection connection) {
    ...
    public List<String[]> call() throws Exception {
        ...
        for (int i = 0; i < hResult.length; i++) {
            ...
            for (int j = 0; j < selectFields.size(); j++) {
                ...
                Cell cell = hResult[i].getColumnLatestCell(Bytes.toBytes(ScanlogDao.FAMILY_NAME), Bytes.toBytes(f));
