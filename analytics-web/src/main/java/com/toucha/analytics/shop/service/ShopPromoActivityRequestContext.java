...
public class ShopPromoActivityRequestContext {
    ...
    public ShopPromoActivityRequestContext(ImmutableList<String> requestFields) {
    ...
    public ShopDataSet compressDataset(ShopDataSet dataSet) {
    ...
    public ShopDataSet truncateDataset(ShopDataSet dataSet) {
        ...
        if (dataSet.getHeader().size() >= this.requestedFields.size()) {
			...
			return new ShopDataSet(this.requestedFields, logs);
        }
