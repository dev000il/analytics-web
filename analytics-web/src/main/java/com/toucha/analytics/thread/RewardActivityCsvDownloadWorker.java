...
public class RewardActivityCsvDownloadWorker implements Runnable {
	...
	public RewardActivityCsvDownloadWorker(String zipBlobName, String pngBlobName,
			GenerateReportCsvRequest request, ScanReportService service) {
		super();
	...
	public ScanReportService getService() {
		return service;
	}

	public void setService(ScanReportService service) {
		this.service = service;
	}
